            ...
            <div class="cast">
                ...
                <div class="cast-images">
                    ...
                    <div class="imgcc">
                        <img src="${
                          imageURL + poster_path
                        }" alt="Thrisha Image" class="cimage">
            ...
            <div class="crew">
                ...
                <div class="cast-images">
                    ...
                    <div class="imgcc">
                        <img src="${
                          imageURL + poster_path
                        }" alt="Anirudh Image" class="cimage">
